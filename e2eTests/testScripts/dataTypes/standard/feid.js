/**
 * Testing data-type "feid" (Federal Tax ID)
 */

module.exports = function(app) {
	describe('"feid"', function() {
		...
		it("Filter support", function(done){
			this.client
				...
				.keys(app.chars.alpha + app.chars.alpha.toUpperCase())
				.execute(function(){
					return ifw.val();
				}, function(err,ret){
		...
		var correctInputs = ['123456789', '12-3456789'];
		var invalidInputs = ['123','123456','1234567890', '123-456789'];
